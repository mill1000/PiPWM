...
// DMA CS Register Control Bits
#define DMA_CS_CONTROL_MASK                (‭0xFFFFFE00‬)
#define DMA_CS_RESET                       (1 << 31)
#define DMA_CS_ABORT                       (1 << 30)
#define DMA_CS_DISDEBUG                    (1 << 29)
#define DMA_CS_WAIT_FOR_OUTSTANDING_WRITES (1 << 28)
#define DMA_CS_PANIC_PRIORITY_SHIFT        (20)
#define DMA_CS_PANIC_PRIORITY_MASK         (0xF << 20)
#define DMA_CS_PRIORITY_SHIFT              (16)
#define DMA_CS_PRIORITY_MASK               (0xF << 16)

// DMA CS Register Status Bits
#define DMA_CS_STATUS_MASK                    (0x1FF)
...
#define DMA_TI_WAITS_MASK (0x1F << 21)
#define DMA_TI_PERMAP_SHIFT (16)
#define DMA_TI_PERMAP_MASK (0x1F << 16)
#define DMA_TI_BURST_LENGTH_SHIFT (12)
#define DMA_TI_BURST_LENGTH_MASK (0xF << 12)
